(define (problem CITYMANAGER)
    ...
    (:init 
        (free car1) (free car2) (free UAV1) (free UAV2) (free robot1) (free robot2) (at car1 Hub1) (at package1 Hub1)
        (at package2 Hub1) (at package3 Hub1) (at package4 Hub1) (at package5 Hub1) (at package6 Hub1) (at package7 Hub1) 
        ...
        (=(distance_land Hub1 Waterloo)80) (=(distance_land Waterloo Hub1)80) 
        (=(distance_land Hub1 Strand)80) (=(distance_land Strand Hub1)80)
        (=(distance_land Waterloo Strand)120) (=(distance_land Strand Waterloo)120)
        (=(distance_land Waterloo LONDON_EYE)160) (=(distance_land LONDON_EYE Waterloo)160) 
        (=(distance_land Strand National_Gallery)100) (=(distance_land National_Gallery Strand)100)
        (=(distance_land Strand China_Town)50) (=(distance_land China_Town Strand)50)
        ...
        (=(weight package6)50) (=(weight package7)50)
        
        (=(speed car1)150) (=(speed car2)150) (=(speed UAV1)100) (=(speed UAV2)100) (=(speed robot1)50) (=(speed robot2)50) 
        
        (=(power_used_rate car1)12) (=(power_used_rate car2)12) (=(power_used_rate UAV1)30) (=(power_used_rate UAV2)30)
        ...
        (=(load_time robot1)0.1) (=(load_time robot2)0.1) (=(load_time UAV1)0.1) (=(load_time UAV2)0.1)
        (=(unload_time robot1)0.1) (=(unload_time robot2)0.1) (=(unload_time UAV1)0.1) (=(unload_time UAV2)0.1) 
        
        (=(carrying_capacity UAV1)50) (=(carrying_capacity UAV2)50) (=(carrying_capacity robot1)100) (=(carrying_capacity robot2)100) 
        ...
        (=(max_goods_position UAV1)1) (=(max_goods_position UAV2)1)
        
        (=(charge_rate_in_hub car1)20) (=(charge_rate_in_hub car2)20) (=(charge_rate_in_hub UAV1)30) (=(charge_rate_in_hub UAV2)30)
        (=(charge_rate_in_hub robot1)30) (=(charge_rate_in_hub robot2)30) 
        (=(charge_rate_in_car robot1)5) (=(charge_rate_in_car robot2)5)
        (=(power_level car1)100) (=(power_level car2)100) (=(power_level UAV1)100) (=(power_level UAV2)100) (=(power_level robot1)100)
        (=(power_level robot2)100) 
        
    )
    
    (:goal (and 
        (at package1 China_Town)(at package2 Strand) (at package3 Waterloo) (at package4 National_Gallery) 
        (at package5 Strand) (at package6 Waterloo) (at package7 National_Gallery) 
        )
    )
    (:metric
        minimize (total-time)
